...
### Always use Parameterized Queries for Filters
...
Please refer to the official documentation on [parameterized queries in Azure Cosmos DB for NoSQL](https://learn.microsoft.com/en-us/azure/cosmos-db/nosql/query/parameterized-queries) for usage examples and best practices.
